...
function tutorial1(stage)
{
	switch(stage)
	{
		...
		case 2:
			...
			break;
		case 3:
			text = "Use the controls on the lower right to control the cannon.\nThe circular arrows aim the cannon. The up and down arrows control the altitude.";
			arrowVisible = true;
...
function tutorial2(stage)
{
	switch(stage)
	{
		...
		case 13:
			...
			text = "This concludes the second tutorial. Try exploring the game levels, and complete the third tutorial at a later date. Happy cannonballing!";
			nextVisible = false;
