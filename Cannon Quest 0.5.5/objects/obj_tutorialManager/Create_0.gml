...
function tutorial3(stage)
{
	switch(stage)
	{
		...
		case 4:
			...
			text = "With the ship selected, fire the main engine use the forward button, or by using the arrow keys/the W key on your keyboard.";
		...
		case 5:
			arrowVisible = false;	
			text = "By increasing and decreasing speed relative to other objects, a spaceship can move through space, change it's orbit, and potentially even orbit other objects.";
			nextVisible = true;
			break;
		case 6:
			arrowVisible = true;
