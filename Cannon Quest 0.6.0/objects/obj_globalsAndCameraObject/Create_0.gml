...
//Indented comments are set in the main menu init
...
globalvar G; //Real world: 6.673 * power(10, -11)
...
globalvar fireSpeed;
	//fireSpeed = 5.0;
globalvar fireSpeed_multiplier;//Allows us to modify fireSpeed without affecting display
...
//globalvar autoOrbitCannonballs;
//autoOrbitCannonballs = true;
